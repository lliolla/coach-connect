...
export const WorkoutProgramEmail = ({ athleteName, programTitle, notes }: EmailProps) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        {/* Tu pourras changer ce lien avec l'URL de ton app */}
...
const button = { backgroundColor: '#000000', borderRadius: '5px', color: '#fff', fontSize: '16px', fontWeight: 'bold', textDecoration: 'none', textAlign: 'center' as const, display: 'block', padding: '12px', marginTop: '24px' };